...
class Radio {
  ...
  renderBg(context, min, radio, lineWidth, padding) {
  ...
  renderFg(context, min, radio, lineWidth, padding) {
    var self = this;
    var sum = 0;
  ...
  renderItem(item, i, context, min, radio, lineWidth, padding, count, sum) {
  ...
  renderTxtItem(item, i, context, x, offset, count, discRadio, txtColor, fontSize, lineHeight) {
    var color = getColor(this.option, i);
